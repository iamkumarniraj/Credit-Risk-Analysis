...
Conclusion: 
Overall, the model has a good performance with an accuracy of 0.82, it also well-suited for identifying instances of class 1. Hence, Decision Tree model is finalized, it can be used to identify credit card holders who are at high risk of defaulting on their payments. This information can be used by credit card companies to manage their risk and avoid losses due to defaults.
